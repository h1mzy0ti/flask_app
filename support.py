...
# Read the comments carefully to implement - himzyoti
# First check the degault authentication plugin after intalling and configuring mysql, (mostcases >  caching_sha2_password or mysql_native_password )
def connect_db(host="localhost", user="root", passwd="You12@", port=3306, database='expense', auth_plugin='mysql_native_password'):
    """
    Connect to database
    :param host: host
    :param user: username
